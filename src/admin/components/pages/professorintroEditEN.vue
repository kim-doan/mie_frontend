<template>
  <div>
      ...
      -->
        ...
        <historyTable :language='1'></historyTable>
        <activityTable :language='1'></activityTable>
  </div>
</template>
<script>
...
export default {
  ...
  methods : {
    ...
    updateProfile () {
        //프로필 수정 1 = 영문 2 = 한국어
        axios.put('http://35.200.100.93:8080/api/intro/professor/update/1', this.professor.data)
        .then(r => {
    ...
    updateimage () {
        //프로필 수정 1 = 영문 2 = 한국어
        axios.post('http://35.200.100.93:8080/api/intro/professor/update/image/1', this.image, {
          headers: {
